...
/**
 * La classe Stagiaire est une classe de base non instanciable (abstract)
 * @author bmartin
 *
 */
//HERITAGE
//La classe de base généralise (mutualise) les comportements de type Stagiaire
public abstract class Stagiaire {
	...
	//HERITAGE
	//La classe de base impose des comportements à ses classes dérivées (ici de définir leur nature)
