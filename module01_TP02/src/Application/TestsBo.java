...
public class TestsBo {
	...
	public static void main(String[] args) {
		...
		Contact c1 = new Personnel(1, "Tom", "0601020304", "tom@campus-eni.fr", false, a1, LocalDate.of(2000, 9, 22));
		Contact c2 = new Personnel(2, "Felix", "0605060708", "felix@campus-eni.fr", false, a2, LocalDate.of(2005, 5, 10));
		Contact c3 = new Professionnel(3, "Samuel", "0609101112", "samuel@campus-eni.fr", false, a3, "ENI Ecole");
		Contact c4 = new Professionnel(4, "Jade", "0613141516", "jade@campus-eni.fr", false, a3, "ENI Ecole");
		Contact c5 = new Professionnel(5, "Lauryne", "0617181920", "charline@campus-eni.fr", false, null, "Xpert");	
